...
from data_loader import get_train_loader, get_test_loader, get_custom_cifar_loader
from at import AT
...
def train(opt):
    ...
    for epoch in range(0, opt.epochs):
        ...
        train_step(opt, train_clean_loader, nets, optimizer, criterions, epoch+1)

        # evaluate on testing set
        print('testing the models......')
        acc_clean, acc_bad = test(opt, test_clean_loader, test_adv_loader, nets, criterions, epoch+1)
