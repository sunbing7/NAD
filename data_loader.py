...
def get_custom_cifar_loader(data_file, batch_size, target_class=6, t_attack='green', portion=100):
    ...
    data = CustomCifarAttackDataSet(data_file, is_train=1, t_attack=t_attack, mode='mix', target_class=target_class, transform=tf_test, portion=portion)
    train_mix_loader = DataLoader(data, batch_size=batch_size, shuffle=True)

    data = CustomCifarAttackDataSet(data_file, is_train=1, t_attack=t_attack, mode='clean', target_class=target_class, transform=tf_test, portion=portion)
    ...
    data = CustomCifarAttackDataSet(data_file, is_train=0, t_attack=t_attack, mode='clean', target_class=target_class, transform=tf_test, portion=portion)
